    ...
    <> 
      {showModal
        ...
        <div className="flex justify-center w-full h-full items-center fixed bg-gray-100">
          <Zoom duration={300}>
            <div className="grid grid-rows-2 tablet:w-4/12 tablet:h-4/6  w-8/12 h-2/6 relative z-10 shadow-lg rounded-2xl bg-white">
              <button className="cursor-pointer absolute right-3 top-3 rounded-full w-6 h-6 bg-green-600 text-white font-mono hover:bg-green-700" onClick={toggleModal}> X </button>
              <div className="flex">
              ...
              <div className="flex flex-col items-center h-full">
                ...
                <p className="w-10/12 text-tiny tablet:text-s font-theme"> {modalData.description} </p>

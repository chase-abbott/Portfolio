        ...
        <div className="flex justify-center items-center ">     
          <div className="flex flex-col tablet:w-7/12 tablet:h-4/6  w-11/12 h-2/5 bg-white">
            ...
            <div className="flex flex-col items-center p-4">
              <h2 className="tablet:text-3xl text-xl text-green-600 font-theme tablet:mt-4"> {componentData.name} </h2>
              <h6 className="tablet:text-xl text-xs text-green-600 font-theme"> {componentData.tools} </h6>
